...
Процедура ПриОпределенииНастроек(Настройки) Экспорт
	...
	// АльфаАвто
	ПользователиАльфаАвто.ПриОпределенииНастроек(Настройки);
	// Конец АльфаАвто
...
Процедура ПриОпределенииНазначенияРолей(НазначениеРолей) Экспорт
	...
	// АльфаАвто
	ПользователиПереопределяемыйАльфаАвто.ПриОпределенииНазначенияРолей(НазначениеРолей);
	// Конец АльфаАвто
...
Процедура ИзменитьДействияВФорме(Знач ПользовательИлиГруппа, Знач ДействияВФорме) Экспорт
	...
	// АльфаАвто
	ПользователиАльфаАвто.ИзменитьДействияВФорме(ПользовательИлиГруппа, ДействияВФорме);
	// Конец АльфаАвто

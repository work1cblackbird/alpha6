...
Функция КодТипаМаркировкиККТ(ТипМаркировкиККТ) Экспорт
	...
	// АльфаАвто
	// Получим код типа маркировки из справочника
	Если ТипЗнч(ТипМаркировкиККТ) = Тип("СправочникСсылка.ТипыМаркировки") Тогда
		Возврат МенеджерОборудованияАльфаАвтоВызовСервера.КодТипаМаркировки(ТипМаркировкиККТ);
	КонецЕсли;
	// Конец АльфаАвто
...
Функция ТипМаркировкиККТПоКоду(КодТипМаркировкиККТ) Экспорт
	...
	// АльфаАвто
	// Получим тип маркировки из справочника
	ТипМаркировки = МенеджерОборудованияАльфаАвтоВызовСервера.ТипМаркировкиПоКоду(КодТипМаркировкиККТ);
	Если ТипМаркировки <> Неопределено Тогда
		Возврат ТипМаркировки;
	КонецЕсли;
	// Конец АльфаАвто

...
Процедура ПриОпределенииИспользуемыхТиповЭлектронныхДокументов(ИспользуемыеТипы) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ПриОпределенииИспользуемыхТиповЭлектронныхДокументов(ИспользуемыеТипы);
	// Конец АльфаАвто
...
Процедура ПодготовитьСтруктуруОбъектовКомандЭДО(СоставКомандЭДО) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ПодготовитьСтруктуруОбъектовКомандЭДО(СоставКомандЭДО);
	// Конец АльфаАвто
...
Процедура ДополнительнаяАналитикаКонтрагентовСправочникПартнеры(ИспользуетсяСправочникПартнеры) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ДополнительнаяАналитикаКонтрагентовСправочникПартнеры(ИспользуетсяСправочникПартнеры);
	// Конец АльфаАвто
...
Процедура ИспользоватьОбменЭДМеждуОрганизациями(Отказ) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ИспользоватьОбменЭДМеждуОрганизациями(Отказ);
	// Конец АльфаАвто
...
Процедура ИспользоватьПрямойОбмен(Использовать) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ИспользоватьПрямойОбмен(Использовать);
	// Конец АльфаАвто
...
Процедура РазрешеноИспользоватьВнутреннийЭДО(Использовать) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.РазрешеноИспользоватьВнутреннийЭДО(Использовать);
	// Конец АльфаАвто
...
Процедура ПриОпределенииОбъектовМетаданныхСПоддержкойДиагностикиОшибок(СписокЭлементов) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ПриОпределенииОбъектовМетаданныхСПоддержкойДиагностикиОшибок(СписокЭлементов);
	// Конец АльфаАвто
...
Процедура ПриПроверкеИспользованияУведомлений(Используется) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ПриПроверкеИспользованияУведомлений(Используется);
	// Конец АльфаАвто
...
Процедура ИспользованиеНастройкиФормированияУниверсальныхДокументов(Использовать = Истина) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ИспользованиеНастройкиФормированияУниверсальныхДокументов(Использовать);
	// Конец АльфаАвто
...
Процедура ПолучитьСоответствиеПеречислений(СоответствиеПеречислений) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ПолучитьСоответствиеПеречислений(СоответствиеПеречислений);
	// Конец АльфаАвто
...
Процедура ПолучитьЗначениеПеречисления(ИмяПеречисления, ПредставлениеПеречисления, НайденноеЗначение) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ПолучитьЗначениеПеречисления(ИмяПеречисления,
		ПредставлениеПеречисления, НайденноеЗначение);
	// Конец АльфаАвто
...
Процедура ЗаполнитьСоответствиеСтавокНДС(Соответствие) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ЗаполнитьСоответствиеСтавокНДС(Соответствие);
	// Конец АльфаАвто
...
Процедура СоответствиеИсходящихТиповЭлектронныхДокументовДокументамИБ(СоответствиеТиповЭлектронныхДокументовДокументамИБ) Экспорт 
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.СоответствиеИсходящихТиповЭлектронныхДокументовДокументамИБ(
...
Процедура СписокТиповДокументовПоТипуЭлектронногоДокумента(ТипДокумента, ОписанияОбъектовУчета) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.СписокТиповДокументовПоТипуЭлектронногоДокумента(ТипДокумента, ОписанияОбъектовУчета);
	// Конец АльфаАвто
...
Процедура ЗаполнитьПараметрыЭДПоИсточнику(Источник, ПараметрыЭлектронногоДокумента) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ЗаполнитьПараметрыЭДПоИсточнику(Источник, ПараметрыЭлектронногоДокумента);
	// Конец АльфаАвто
...
Процедура ПолучитьЗапросКонструктораДополнительныхПолейШапки(Параметры, ТекстЗапроса) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ПолучитьЗапросКонструктораДополнительныхПолейШапки(Параметры, ТекстЗапроса);
	// Конец АльфаАвто
...
Процедура ЗаполнитьДанныеУКД2020_ИнформацияПродавца(Знач Основание, Знач Настройки, Данные, Описание, Отказ) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ЗаполнитьДанныеУКД2020_ИнформацияПродавца(
		Основание,
		Настройки,
		Данные,
		Описание,
...
Процедура ЗаполнитьДанныеУКД2020_ИнформацияПокупателя(Знач Основания, Данные, Отказ) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ЗаполнитьДанныеУКД2020_ИнформацияПокупателя(Основания, Данные, Отказ);
	// Конец АльфаАвто
...
Процедура НайтиСоздатьУКД_2020(ДеревоДанных, СсылкиНаВладельцев = Неопределено, СпособОбработки  = Неопределено, ОписаниеОшибки = "") Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.НайтиСоздатьУКД_2020(
		ДеревоДанных,
		СсылкиНаВладельцев,
		СпособОбработки,
		ОписаниеОшибки
...
Процедура ЗаполнитьДанныеУПД_5_02_ИнформацияПродавца(Знач Основание, Знач Настройки, Данные, Описание, Отказ) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ЗаполнитьДанныеУПД_5_02_ИнформацияПродавца(
		Основание,
		Настройки,
		Данные,
		Описание,
...
Процедура ЗаполнитьДанныеУПД_5_02_ИнформацияПокупателя(Знач Основания, Данные, Отказ) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ЗаполнитьДанныеУПД_5_02_ИнформацияПокупателя(Основания, Данные, Отказ);
	// Конец АльфаАвто
...
Процедура НайтиСоздатьУниверсальныйПередаточныйДокумент_5_02(ДеревоДанных, СсылкиНаВладельцев = Неопределено, СпособОбработки = Неопределено, ОписаниеОшибки = "") Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.НайтиСоздатьУниверсальныйПередаточныйДокумент_5_02(
		ДеревоДанных,
		СсылкиНаВладельцев,
		СпособОбработки,
		ОписаниеОшибки
...
Процедура ЗаполнитьДанныеУПД2019_ИнформацияПродавца(Знач Основание, Знач Настройки, Данные, Описание, Отказ) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ЗаполнитьДанныеУПД2019_ИнформацияПродавца(
		Основание,
		Настройки,
		Данные,
		Описание,
...
Процедура ЗаполнитьДанныеУПД2019_ИнформацияПокупателя(Знач Основания, Данные, Отказ) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ЗаполнитьДанныеУПД2019_ИнформацияПокупателя(Основания, Данные, Отказ);
	// Конец АльфаАвто
...
Процедура НайтиСоздатьУниверсальныйПередаточныйДокумент_2019(ДеревоДанных, СсылкиНаВладельцев = Неопределено, СпособОбработки = Неопределено, ОписаниеОшибки = "") Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.НайтиСоздатьУниверсальныйПередаточныйДокумент_2019(
		ДеревоДанных,
		СсылкиНаВладельцев,
		СпособОбработки,
		ОписаниеОшибки
...
Процедура ЗаполнитьДанныеУПД_ИнформацияПокупателя(Знач Основания, Данные, Отказ) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ЗаполнитьДанныеУПД_ИнформацияПокупателя(Основания, Данные, Отказ);
	// Конец АльфаАвто
...
Процедура НайтиСоздатьУниверсальныйПередаточныйДокумент(ДеревоДанных, СсылкиНаВладельцев = Неопределено,
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.НайтиСоздатьУниверсальныйПередаточныйДокумент(
		ДеревоДанных,
		СсылкиНаВладельцев,
		СпособОбработки,
		ОписаниеОшибки
...
Процедура ЗаполнитьДанныеУКД_ИнформацияПродавца(Знач Основание, Знач Настройки, Данные, Описание, Отказ) Экспорт 
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ЗаполнитьДанныеУКД_ИнформацияПродавца(
		Основание,
		Настройки,
		Данные,
		Описание,
...
Процедура ЗаполнитьДанныеУКД_ИнформацияПокупателя(Знач Основания, Данные, Отказ) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ЗаполнитьДанныеУКД_ИнформацияПокупателя(
		Основания,
		Данные,
		Отказ
	);
...
Процедура НайтиСоздатьУниверсальныйКорректировочныйДокумент(ДеревоДанных, СсылкиНаВладельцев = Неопределено,
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.НайтиСоздатьУниверсальныйКорректировочныйДокумент(
		ДеревоДанных,
		СсылкиНаВладельцев,
		СпособОбработки,
		ОписаниеОшибки
...
Процедура ЗаполнитьДанныеПередачаТоваров_ИнформацияПродавца(Знач Основание, Знач Настройки, Данные, Описание, Отказ) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ЗаполнитьДанныеПередачаТоваров_ИнформацияПродавца(
		Основание,
		Настройки,
		Данные,
		Описание,
...
Процедура ЗаполнитьДанныеПередачаТоваров_ИнформацияПокупателя(Знач Основания, Данные, Отказ) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ЗаполнитьДанныеПередачаТоваров_ИнформацияПокупателя(Основания, Данные, Отказ);
	// Конец АльфаАвто
...
Процедура НайтиСоздатьДокументПередачаТоваров(ДеревоДанных, СсылкаНаВладельца, СпособОбработки = "", ОписаниеОшибки = "") Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.НайтиСоздатьДокументПередачаТоваров(
		ДеревоДанных,
		СсылкаНаВладельца,
		СпособОбработки,
		ОписаниеОшибки
...
Процедура ЗаполнитьДанныеПередачаУслуг_ИнформацияПродавца(Знач Основание, Знач Настройки, Данные, Описание, Отказ) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ЗаполнитьДанныеПередачаУслуг_ИнформацияПродавца(
		Основание,
		Настройки,
		Данные,
		Описание,
...
Процедура ЗаполнитьДанныеПередачаУслуг_ИнформацияПокупателя(Знач Основания, Данные, Отказ) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ЗаполнитьДанныеПередачаУслуг_ИнформацияПокупателя(
		Основания,
		Данные,
		Отказ
	);
...
Процедура НайтиСоздатьДокументПередачаРезультатовРабот(ДеревоДанных, СсылкаНаВладельца, СпособОбработки = "", ОписаниеОшибки = "") Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.НайтиСоздатьДокументПередачаРезультатовРабот(
		ДеревоДанных,
		СсылкаНаВладельца,
		СпособОбработки,
		ОписаниеОшибки
...
Процедура ЗаполнитьДанныеАктСверкиВзаиморасчетов_ИнформацияОтправителя(Знач Основание, Знач Настройки, Данные, Описание, Отказ) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ЗаполнитьДанныеАктСверкиВзаиморасчетов_ИнформацияОтправителя(
		Основание,
		Настройки,
		Данные,
		Описание,
...
Процедура ЗаполнитьДанныеАктСверкиВзаиморасчетов_ИнформацияПолучателя(Знач Основание, Знач Настройки, Данные, Описание, Отказ) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ЗаполнитьДанныеАктСверкиВзаиморасчетов_ИнформацияПолучателя(
		Основание,
		Настройки,
		Данные,
		Описание,
...
Процедура НайтиСоздатьАктСверкиВзаиморасчетов(ДеревоДанных, ДокументУчета = Неопределено, СпособОбработки = "", ОписаниеОшибки = "") Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.НайтиСоздатьАктСверкиВзаиморасчетов(
		ДеревоДанных,
		ДокументУчета,
		СпособОбработки,
		ОписаниеОшибки);
...
Процедура ЗаполнитьАктСверкиВзаиморасчетовПоДаннымПолучателя(ДанныеДокумента, ОбъектыУчета = Неопределено) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ЗаполнитьАктСверкиВзаиморасчетовПоДаннымПолучателя(ДанныеДокумента, ОбъектыУчета);
	// Конец АльфаАвто
...
Процедура ЗаполнитьДанныеРеквизитыОрганизации(СсылкаНаОбъект, Данные, Отказ) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ЗаполнитьДанныеРеквизитыОрганизации(СсылкаНаОбъект, Данные, Отказ);
	// Конец АльфаАвто
...
Процедура ЗаполнитьДанныеПоСчету(СсылкаНаОбъект, ДеревоДокумента, Отказ) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ЗаполнитьДанныеПоСчету(СсылкаНаОбъект, ДеревоДокумента, Отказ);
	// Конец АльфаАвто
...
Процедура ЗаполнитьДанныеПоЗаказуТоваров(СсылкаНаОбъект, ДеревоДокумента, Отказ) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ЗаполнитьДанныеПоЗаказуТоваров(СсылкаНаОбъект, ДеревоДокумента, Отказ);
	// Конец АльфаАвто
...
Процедура ЗаполнитьДанныеПоОтветуНаЗаказ(СсылкаНаОбъект, ДеревоДокумента, Отказ) Экспорт
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ЗаполнитьДанныеПоОтветуНаЗаказ(СсылкаНаОбъект, ДеревоДокумента, Отказ);
	// Конец АльфаАвто
КонецПроцедуры
...
Процедура СохранитьДанныеОбъектаВБД(СтрокаДляЗагрузки, ДеревоРазбора, ПараметрыОбработки = Неопределено,
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.СохранитьДанныеОбъектаВБД(
		СтрокаДляЗагрузки,
		ДеревоРазбора,
...
Процедура СоздатьОбъектВБД(СтрокаОбъекта, ДеревоРазбора, НовыйЭлемент) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.СоздатьОбъектВБД(СтрокаОбъекта, ДеревоРазбора, НовыйЭлемент);
	// Конец АльфаАвто
...
Процедура ЗаполнитьТаблицуПорядкаСозданияТиповОбъектов(Таблица) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ЗаполнитьТаблицуПорядкаСозданияТиповОбъектов(Таблица);
	// Конец АльфаАвто
...
Процедура СпособыОтраженияВУчетеТипаЭлектронногоДокумента(ТипДокумента, СпособыОтраженияВУчете) Экспорт 
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.СпособыОтраженияВУчетеТипаЭлектронногоДокумента(ТипДокумента, СпособыОтраженияВУчете);
	// Конец АльфаАвто
...
Процедура ПриПроверкеВозможностиСозданияУчетногоДокумента(Знач Параметры, Отказ, Описание) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ПриПроверкеВозможностиСозданияУчетногоДокумента(Параметры, Отказ, Описание);
	// Конец АльфаАвто
...
Процедура ОпределитьДокументЯвляетсяСчетомФактурой(ДокументСсылка, Результат) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ОпределитьДокументЯвляетсяСчетомФактурой(ДокументСсылка, Результат);
	// Конец АльфаАвто
...
Процедура ПриПолученииОписанияОснованияЭлектронногоДокумента(ОснованиеОбъект, Описание, СтандартнаяОбработка) Экспорт
	...
	Реквизиты = ИнтеграцияЭДО.ЗначенияРеквизитовОбъектаУчета(ОснованиеОбъект, "Дата,Номер,Организация,Контрагент,СуммаДокумента");	
	ЗаполнитьЗначенияСвойств(Описание, Реквизиты);
	
	СоставОбщихРеквизитов = Новый Массив();
	СоставОбщихРеквизитов.Добавить("Организация");
	СоставОбщихРеквизитов.Добавить("СуммаДокумента");       
	МетаданныеОбъекта = ОснованиеОбъект.Метаданные();
	
	Для Каждого ОбщРеквизит Из СоставОбщихРеквизитов Цикл
		ПринадлежностьДокумента = Метаданные.ОбщиеРеквизиты[ОбщРеквизит].Состав.Найти(МетаданныеОбъекта);
		
		Если ПринадлежностьДокумента <> Неопределено 
			И ПринадлежностьДокумента.Использование = Метаданные.СвойстваОбъектов.ИспользованиеОбщегоРеквизита.Использовать 
			И Описание.Свойство(ОбщРеквизит)
			И ЗначениеЗаполнено(ОснованиеОбъект[ОбщРеквизит]) Тогда 
			Описание[ОбщРеквизит] = ОснованиеОбъект[ОбщРеквизит];
		КонецЕсли;		
	КонецЦикла;
КонецПроцедуры
...
Процедура СсылкаНаОбъектПоИННКПП(ТипОбъекта, ИНН, КПП, Ссылка, ДатаСведений = Неопределено) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.СсылкаНаОбъектПоИННКПП(ТипОбъекта, ИНН, КПП, Ссылка, ДатаСведений);
	// Конец АльфаАвто
...
Процедура СоздатьКонтрагентаПоРеквизитам(Знач РеквизитыКонтрагента, Контрагент, Отказ = Ложь) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.СоздатьКонтрагентаПоРеквизитам(РеквизитыКонтрагента, Контрагент, Отказ);
	// Конец АльфаАвто
...
Процедура ЗаполнитьРеквизитыКонтрагента(СтруктураРеквизитов, КонтрагентСсылка) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ЗаполнитьРеквизитыКонтрагента(СтруктураРеквизитов, КонтрагентСсылка);
	// Конец АльфаАвто
...
Процедура ПолучитьРеквизитыОрганизацииДляВыгрузкиВФайл(Организация, СтруктураВозврата) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ПолучитьРеквизитыОрганизацииДляВыгрузкиВФайл(Организация, СтруктураВозврата);
	// Конец АльфаАвто
...
Процедура ЗаполнитьРегистрационныеДанныеОрганизации(Организация, ДанныеОрганизации) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ЗаполнитьРегистрационныеДанныеОрганизации(Организация, ДанныеОрганизации);
	// Конец АльфаАвто
...
Процедура ДанныеСвидетельстваОРегистрацииИП(ИП, Сведения) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ДанныеСвидетельстваОРегистрацииИП(ИП, Сведения);
	// Конец АльфаАвто
...
Процедура АдресЭлектроннойПочтыКонтрагента(Контрагент, АдресЭП) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.АдресЭлектроннойПочтыКонтрагента(Контрагент, АдресЭП);
	// Конец АльфаАвто
...
Процедура ПолучитьБанковскиеСчета(Организация, Таблица) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ПолучитьБанковскиеСчета(Организация, Таблица);
	// Конец АльфаАвто
...
Процедура ПолучитьБанковскиеРеквизиты(МассивСчетов, Таблица) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ПолучитьБанковскиеРеквизиты(МассивСчетов, Таблица);
	// Конец АльфаАвто
...
Процедура ЭтоФизЛицо(ДанныеКонтрагента, ПризнакФизЛица) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.ЭтоФизЛицо(ДанныеКонтрагента, ПризнакФизЛица);
	// Конец АльфаАвто
...
Процедура СведенияФизЛицаПользователя(Знач Пользователь, Знач Организация, СведенияФизЛица) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.СведенияФизЛицаПользователя(Пользователь, Организация, СведенияФизЛица);
	// Конец АльфаАвто
...
Процедура СуммаПрописью(СуммаЧислом, КодВалюты, Результат) Экспорт
	...
	// АльфаАвто
	ОбменСКонтрагентамиАльфаАвто.СуммаПрописью(СуммаЧислом, КодВалюты, Результат);
	// Конец АльфаАвто

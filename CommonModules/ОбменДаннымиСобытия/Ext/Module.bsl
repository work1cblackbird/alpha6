...
Процедура ПриСозданииВерсииОбъекта(Объект, СведенияОВерсииОбъекта, СсылкаСуществует, Отправитель) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.ВерсионированиеОбъектов") Тогда
		...
		СведенияОНовойВерсииОбъекта.Вставить("Компьютер", ИмяКомпьютера);
		...
		Если Объект.ДополнительныеСвойства.Свойство("__РегистрацияИзменений__ПередЗаписью") Тогда
			Если Объект.ДополнительныеСвойства.__РегистрацияИзменений__ПередЗаписью.Свойство("Событие") Тогда
				СведенияОНовойВерсииОбъекта.Вставить(
					"Событие",
				Объект.ДополнительныеСвойства.__РегистрацияИзменений__ПередЗаписью.Событие); // событие документа
			Иначе
				СведенияОНовойВерсииОбъекта.Вставить(
					"Событие",
					Перечисления.СобытияВерсионирования.Запись); // по умолчанию - запись
			КонецЕсли;
		Иначе
			СведенияОНовойВерсииОбъекта.Вставить(
				"Событие",
				Перечисления.СобытияВерсионирования.Запись); // для справочника - всегда запись
		КонецЕсли;

...
Процедура ПриЗаполненииРеквизитовОрганизацииВЗаявленииНаСертификат(Параметры) Экспорт
	...
	// АльфаАвто
	ЗаявлениеНаСертификатАльфаАвто.ПриЗаполненииРеквизитовОрганизацииВЗаявленииНаСертификат(Параметры);
	// Конец АльфаАвто
...
Процедура ПриЗаполненииРеквизитовВладельцаВЗаявленииНаСертификат(Параметры) Экспорт
	...
	// АльфаАвто
	ЗаявлениеНаСертификатАльфаАвто.ПриЗаполненииРеквизитовВладельцаВЗаявленииНаСертификат(Параметры);
	// Конец АльфаАвто
...
Процедура ПриЗаполненииРеквизитовРуководителяВЗаявленииНаСертификат(Параметры) Экспорт
	...
	// АльфаАвто
	ЗаявлениеНаСертификатАльфаАвто.ПриЗаполненииРеквизитовРуководителяВЗаявленииНаСертификат(Параметры);
	// Конец АльфаАвто

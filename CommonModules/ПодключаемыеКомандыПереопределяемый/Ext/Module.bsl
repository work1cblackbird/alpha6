...
Процедура ПриОпределенииВидовПодключаемыхКоманд(ВидыПодключаемыхКоманд) Экспорт
	...
	// АльфаАвто
	ОбщиеПараметрыДокументов.ПриОпределенииВидовПодключаемыхКоманд(ВидыПодключаемыхКоманд);
	ДополнительнаяФормаОбъекта.ПриОпределенииВидовПодключаемыхКоманд(ВидыПодключаемыхКоманд);
	СортировкаТабличнойЧастиДокумента.ПриОпределенииВидовПодключаемыхКоманд(ВидыПодключаемыхКоманд);
	// Конец АльфаАвто
...
Процедура ПриОпределенииСоставаНастроекПодключаемыхОбъектов(НастройкиПрограммногоИнтерфейса) Экспорт
	...
	// АльфаАвто
	СортировкаТабличнойЧастиДокумента.ПриОпределенииСоставаНастроекПодключаемыхОбъектов(НастройкиПрограммногоИнтерфейса);
	// Конец АльфаАвто
...
Процедура ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды) Экспорт
	...
	// АльфаАвто
	ОбщиеПараметрыДокументов.ИнициализироватьКомандуПараметровДокумента(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды);
	ПечатьРеестраДокументов.ИнициализироватьКомандуПечатиРеестра(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды);       
	КомплектыПечати.ИнициализироватьКомандуКомплектовПечати(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды); 
	ПараметрыПечатиСервер.ИнициализироватьКомандуПараметровПечати(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды);
	ДополнительнаяФормаОбъекта.ИнициализироватьКомандуДополнительнойФормы(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды);
	СортировкаТабличнойЧастиДокумента.ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды);
	// Конец АльфаАвто

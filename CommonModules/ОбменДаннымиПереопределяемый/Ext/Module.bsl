...
Процедура ПриОпределенииПрефиксаИнформационнойБазыПоУмолчанию(Префикс) Экспорт
	...
	// АльфаАвто
	ОбменДаннымиАльфаАвто.ПриОпределенииПрефиксаИнформационнойБазыПоУмолчанию(Префикс);
	// Конец АльфаАвто
...
Процедура ПолучитьПланыОбмена(ПланыОбменаПодсистемы) Экспорт
	...
	// АльфаАвто
	ОбменДаннымиАльфаАвто.ПолучитьПланыОбмена(ПланыОбменаПодсистемы);
	// Конец АльфаАвто
...
Процедура РегистрацияИзмененийНачальнойВыгрузкиДанных(Знач Получатель, СтандартнаяОбработка, Отбор) Экспорт
	...
	// АльфаАвто
	ОбменДаннымиАльфаАвто.РегистрацияИзмененийНачальнойВыгрузкиДанных(Получатель, СтандартнаяОбработка, Отбор);
	// Конец АльфаАвто
...
Процедура ПриПолученииДоступныхВерсийФормата(ВерсииФормата) Экспорт
	...
	// АльфаАвто
	ОбменДаннымиАльфаАвто.ПриПолученииДоступныхВерсийФормата(ВерсииФормата);
	// Конец АльфаАвто

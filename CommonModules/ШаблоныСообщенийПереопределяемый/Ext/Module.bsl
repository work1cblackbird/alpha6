...
Процедура ПриОпределенииНастроек(Настройки) Экспорт
	...
	Предмет.Имя = Обработки.КонтактЦентр.ИмяПредметаШаблонаСообщения();
	Предмет.Представление = Метаданные.Обработки.КонтактЦентр.Синоним;
	
	Предмет = Настройки.ПредметыШаблонов.Добавить();
	Предмет.Имя = Обработки.АктивацияБонусныхБаллов.ИмяПредметаШаблонаСообщения();
	Предмет.Представление = Метаданные.Обработки.АктивацияБонусныхБаллов.Синоним;
	// Конец АльфаАвто
...
Процедура ПриПодготовкеШаблонаСообщения(Реквизиты, Вложения, НазначениеШаблона, ДополнительныеПараметры) Экспорт
	...
	// АльфаАвто
	Если НазначениеШаблона = Обработки.КонтактЦентр.ИмяПредметаШаблонаСообщения() Тогда
		Обработки.КонтактЦентр.ЗаполнитьРеквизитыКонтактЦентра(Реквизиты);
	КонецЕсли;
	Если НазначениеШаблона = Обработки.АктивацияБонусныхБаллов.ИмяПредметаШаблонаСообщения() Тогда
		Обработки.АктивацияБонусныхБаллов.ПриПодготовкеШаблонаСообщения(Реквизиты, Вложения, ДополнительныеПараметры);
	КонецЕсли;
	// Конец АльфаАвто
...
Процедура ПриФормированииСообщения(Сообщение, НазначениеШаблона, ПредметСообщения, ПараметрыШаблона) Экспорт
	...
	// АльфаАвто
	Если НазначениеШаблона = Обработки.АктивацияБонусныхБаллов.ИмяПредметаШаблонаСообщения() Тогда
		Обработки.АктивацияБонусныхБаллов.ПриФормированииСообщения(Сообщение, ПредметСообщения, ПараметрыШаблона);
	КонецЕсли;
	// Конец АльфаАвто

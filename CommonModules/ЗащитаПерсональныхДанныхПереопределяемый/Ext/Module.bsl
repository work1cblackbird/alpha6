...
Процедура ЗаполнитьСведенияОПерсональныхДанных(ТаблицаСведений) Экспорт
	...
	// АльфаАвто
	ЗащитаПерсональныхДанныхАльфаАвто.ЗаполнитьСведенияОПерсональныхДанных(ТаблицаСведений);
	// Конец АльфаАвто
...
Процедура ЗаполнитьОбластиПерсональныхДанных(КатегорииПерсональныхДанных) Экспорт
	...
	// АльфаАвто
	ЗащитаПерсональныхДанныхАльфаАвто.ЗаполнитьОбластиПерсональныхДанных(КатегорииПерсональныхДанных);
	// Конец АльфаАвто
...
Процедура ДополнитьДанныеСубъектовПерсональныхДанных(СубъектыПерсональныхДанных, ДатаАктуальности) Экспорт
	...
	// АльфаАвто
	ЗащитаПерсональныхДанныхАльфаАвто.ДополнитьДанныеСубъектовПерсональныхДанных(
...
Процедура ДополнитьДанныеОрганизацииОператораПерсональныхДанных(Организация, ДанныеОрганизации, ДатаАктуальности) Экспорт
	...
	// АльфаАвто
	ЗащитаПерсональныхДанныхАльфаАвто.ДополнитьДанныеОрганизацииОператораПерсональныхДанных(
		Организация,
		ДанныеОрганизации,
		ДатаАктуальности
	);
...
Процедура ЗаполнитьФИОФизическогоЛица(ФизическоеЛицо, ФИО) Экспорт
	...
	// АльфаАвто
	ЗащитаПерсональныхДанныхАльфаАвто.ЗаполнитьФИОФизическогоЛица(ФизическоеЛицо, ФИО);
	// Конец АльфаАвто
...
Процедура ПриЗаполненииСведенийОбУничтожаемыхПерсональныхДанных(ТаблицаСведений) Экспорт
	...
	// АльфаАвто
	ЗащитаПерсональныхДанныхАльфаАвто.ПриЗаполненииСведенийОбУничтожаемыхПерсональныхДанных(ТаблицаСведений);
	// Конец АльфаАвто

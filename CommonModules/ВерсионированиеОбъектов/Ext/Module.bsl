...
Процедура СоздатьВерсиюОбъекта(Объект, СведенияОВерсииОбъекта, ЗаписьОбычнойВерсии = Истина)
	...
	// АльфаАвто
	МенеджерЗаписи.Компьютер = СведенияОВерсииОбъекта.Компьютер;
	МенеджерЗаписи.Событие   = СведенияОВерсииОбъекта.Событие;
	// Конец АльфаАвто
	МенеджерЗаписи.Записать();
...
Процедура ПриСозданииВерсииОбъекта(Объект, РежимЗаписи)
	...
	// АльфаАвто
	ВерсионированиеОбъектовАльфаАвто.ДобавитьДополнительныеСведенияОВерсииОбъекта(Объект, СведенияОВерсииОбъекта);
	// Конец АльфаАвто

...
Процедура ПриОпределенииВозможныхПредметов(ТипыПредметов) Экспорт
	...
	// АвльфаАвто
	ВзаимодействияАльфаАвтоВызовСервера.ПриОпределенииВозможныхПредметов(ТипыПредметов);
	// Конец АльфаАвто
...
Процедура ПриОпределенииВозможныхКонтактов(ТипыКонтактов) Экспорт
	...
	// АвльфаАвто
	ВзаимодействияАльфаАвтоВызовСервера.ПриОпределенииВозможныхКонтактов(ТипыКонтактов);
	// Конец АльфаАвто

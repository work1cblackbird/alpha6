...
Процедура ПриПоискеКонтактов(Знач ИмяТаблицыКонтактов, ТекстЗапросаДляПоиска) Экспорт
	...
	// АльфаАвто
	ВзаимодействияАльфаАвто.ПриПоискеКонтактов(ИмяТаблицыКонтактов, ТекстЗапросаДляПоиска);
	// Конец АльфаАвто
...
Процедура ПриЗаполненииНаборовЗначенийДоступа(Объект, Таблица) Экспорт
	...
	// АльфаАвто
	ВзаимодействияАльфаАвто.ПриЗаполненииНаборовЗначенийДоступа(Объект, Таблица);
	// Конец АльфаАвто

...
Процедура ПриДобавленииОбработчиковУстановкиПараметровСеанса(Обработчики) Экспорт
	...
	ИнтеграцияПодсистемАльфаАвто.ОбработчикиУстановкаПараметровСеанса(Обработчики);
...
Процедура ПриДобавленииПараметровРаботыКлиентаПриЗапуске(Параметры) Экспорт
	...
	// АльфаАвто
	АльфаАвтоСервер.ПриДобавленииПараметровРаботыКлиентаПриЗапуске(Параметры);
	// Конец АльфаАвто
...
Процедура ПриОпределенииПараметровФункциональныхОпцийИнтерфейса(ОпцииИнтерфейса) Экспорт
	...
	// АльфаАвто
	АльфаАвтоСервер.ПриОпределенииПараметровФункциональныхОпцийИнтерфейса(ОпцииИнтерфейса);
	// Конец АльфаАвто

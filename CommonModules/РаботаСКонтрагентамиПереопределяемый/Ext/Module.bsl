...
Процедура ПриОпределенииСвойствСправочниковКонтрагентов(СвойстваСправочников) Экспорт
	...
	РаботаСКонтрагентамиАльфаАвто.ПриОпределенииСвойствСправочниковКонтрагентов(СвойстваСправочников);
...
Процедура ПриОпределенииКонтрагентЯвляетсяИностранным(ДанныеКонтрагента, ЯвляетсяИностранным) Экспорт
	...
	РаботаСКонтрагентамиАльфаАвто.ПриОпределенииКонтрагентЯвляетсяИностранным(ДанныеКонтрагента, ЯвляетсяИностранным);
...
Процедура ДополнитьРеквизитыФормыКонтрагент(Форма, НовыеРеквизиты) Экспорт
	...
	ДанныеКонтрагента	= Новый Структура("Контрагент", Форма.Объект.Ссылка);
	РаботаСКонтрагентамиАльфаАвто.ПриОпределенииКонтрагентЯвляетсяИностранным(ДанныеКонтрагента, ЯвляетсяИностранным);
	
	НовыеРеквизиты.ЭтоИностранныйКонтрагент = ЯвляетсяИностранным;

...
Процедура ПроверитьДанныеАгента(Проверка, ДанныеЧека, Позиция)
	...
	Если ЗаполненРеквизит(Проверка, Позиция, "ПризнакАгентаПоПредметуРасчета") Тогда
		...
		Если ЕстьРеквизитФЛК(Проверка, ДанныеЧека, "ПризнакАгента", ПризнакАгента) // АльфаАвто
			И ЗначениеЗаполнено(ПризнакАгента)
			И ЕстьРеквизитФЛК(Проверка, Позиция, "ПризнакАгентаПоПредметуРасчета", ПризнакАгентаПоПредметуРасчета) // АльфаАвто
...
Функция ЕстьРеквизитФЛК(Проверка, Данные, Знач ИмяРеквизита, Значение) // АльфаАвто переименовал процедуру, т.к. есть такая глобальная
...
Функция ЗаполненРеквизит(Проверка, Данные, Знач ИмяРеквизита)
	...
	Если ЕстьРеквизитФЛК(Проверка, Данные, ИмяРеквизита, Значение) Тогда  // АльфаАвто
...
Процедура ПроверитьРеквизитВМассивеДанных(Проверка, МассивДанных, Знач ИмяРеквизита = Неопределено, Знач ВерсииФФД = Неопределено, Знач ШаблонОшибки = Неопределено)
	...
	Для Каждого Данные Из МассивДанных Цикл
		Значение = Неопределено;
		Если ЕстьРеквизитФЛК(Проверка, Данные, ИмяРеквизита, Значение) И ЗначениеЗаполнено(Значение) Тогда  // АльфаАвто
...
Процедура ПроверитьРеквизитИНН(Проверка, Данные, Знач ИмяРеквизита)
	...
	Значение = Неопределено;
	Если ЕстьРеквизитФЛК(Проверка, Данные, ИмяРеквизита, Значение) Тогда // АлфьаАвто
		ОписаниеОшибки = "";

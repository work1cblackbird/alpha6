...
Функция НоваяКассоваяСмена(ФискальноеУстройство, ПараметрыКоманды) Экспорт
	...
	// АльфаАвто
	ОрганизацияПодразделения = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ПараметрыСеанса.ПодразделениеКомпании, "Организация");
	Если ОрганизацияПодразделения = КассоваяСменаОбъект.Организация Тогда
		КассоваяСменаОбъект.ПодразделениеКомпании = ПараметрыСеанса.ПодразделениеКомпании;
	КонецЕсли;
	// Конец АльфаАвто

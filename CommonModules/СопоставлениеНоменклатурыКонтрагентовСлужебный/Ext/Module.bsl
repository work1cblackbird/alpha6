...
Процедура ПоискВариантовСопоставленияНоменклатурыСНоменклатуройКонтрагентов(Знач Запрос, ТаблицаНоменклатурыКонтрагентов, Знач ТаблицаНатуральныхКлючей,
	...
	// АльфаАвто
	// Изменен текст запроса
	// ТекстЗапросаВариантовСопоставленияПоНоменклатуреКонтрагентов(Запрос.Текст);
	СопоставлениеНоменклатурыКонтрагентовАльфаАвто.ТекстЗапросаВариантовСопоставленияПоНоменклатуреКонтрагентов(Запрос.Текст);
	// Конец АльфаАвто
...
Процедура ИнициализацияТекстаЗапросаПоискаВСловареСопоставленияПоНоменклатуры(ТекстЗапроса, ПараметрыСопоставления)
	...
	// АльфаАвто
	// Изменился текст запроса для фильтрации по типу справочника
	// ТекстЗапроса = ТекстЗапросаПоискаВариантовСопоставленияВСловареПоНаименованию(ПараметрыСопоставления);
		ТекстЗапроса =
			СопоставлениеНоменклатурыКонтрагентовАльфаАвто.ТекстЗапросаПоискаВариантовСопоставленияВСловареПоНаименованию(

...
Функция НайтиРабочиеМестаПоИдентификатору(ИдентификаторКлиента, ИмяКомпьютера, MACАдрес = "") Экспорт
	...
	ПараметрыУникальностиРабочихМест = МенеджерОборудованияАльфаАвтоВызовСервера.
		ПараметрыПолученияИдентификатораРабочегоМеста();
	
	Если ПараметрыУникальностиРабочихМест.РежимПоиска = РежимыПоискаИдентификатораКлиента.ИмяКомпьютера
		Или ПараметрыУникальностиРабочихМест.РежимПоиска = РежимыПоискаИдентификатораКлиента.ИмяКомпьютераИИмяПользователя Тогда

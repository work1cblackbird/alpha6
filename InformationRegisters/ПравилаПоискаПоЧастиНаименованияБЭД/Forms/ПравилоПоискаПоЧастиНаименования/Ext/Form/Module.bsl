...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// АльфаАвто
	СопоставлениеНоменклатурыКонтрагентовАльфаАвто.ПравилоПоискаПоЧастиНаименованияПриСозданииНаСервере(ЭтотОбъект);
	// Конец АльфаАвто
...
Процедура НоменклатураПриИзмененииНаСервере()
	...
	СопоставлениеНоменклатурыКонтрагентовАльфаАвто.УстановитьВладелецаЕдиницыИзмерения(ЭтотОбъект);

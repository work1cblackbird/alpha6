...
Перем ИзмеренияРегистра Экспорт;   // ТаблицаЗначений Содержит автомобили и Заказы по которым сдвигается граница последовательности
Перем ИзмеренияРегистраБыли Экспорт;   // ТаблицаЗначений Содержит автомобили и Заказы  по которым сдвигается граница последовательности

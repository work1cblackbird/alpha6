...
Перем ИзмеренияРегистра Экспорт;   // ТаблицаЗначений Содержит автомобили и Склады по которым сдвигается граница последовательности
Перем ИзмеренияРегистраБыли Экспорт;   // ТаблицаЗначений Содержит автомобили и Склады  по которым сдвигается граница последовательности

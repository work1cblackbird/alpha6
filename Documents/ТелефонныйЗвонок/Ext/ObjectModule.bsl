...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	сфпСофтФонПроСерверПереопределяемый.ЗаполнитьОбщиеРеквизиты(ЭтотОбъект);
...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	РеквизитОписание =  ПроверяемыеРеквизиты.Найти("Описание");
	ПроверяемыеРеквизиты.Удалить(РеквизитОписание);
	
	РеквизитОписание =  ПроверяемыеРеквизиты.Найти("Тема");
	ПроверяемыеРеквизиты.Удалить(РеквизитОписание); 

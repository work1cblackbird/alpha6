...
Процедура ПоказатьКомментарийСостояния(Команда)
	...
	// АльфаАвто
	// В текущей версии библиотеки появился лишний параметр, до этого его не было
	// В свежей версии БЭД 1.9.12.44 параметр опять убрали
	// При обновлении БЭД вернуть эту форму на полную поддержку

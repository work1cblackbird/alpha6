///////////////////////////////////////////////////////////////////////////////
// Модуль основной формы документа "Корректировка компенсации по маркетинговой программе"
//
///////////////////////////////////////////////////////////////////////////////
...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	РаботаСФормойКлиент.ЗамерВремениЗапись("КорректировкаКомпенсацииПоМаркетинговойПрограмме",
	ПараметрыЗаписи.РежимЗаписи, Ложь);
...
&НаКлиенте
Процедура СоставКомпенсацииАктивностьПриИзменении(Элемент)
	
	ТекущиеДанные = Элементы.СоставКомпенсации.ТекущиеДанные;
	ТекущиеДанные.СуммаКорректировки = ?(ТекущиеДанные.Активность, ТекущиеДанные.Сумма, 0);
	ТекущиеДанные.Разница = ТекущиеДанные.СуммаКорректировки - ТекущиеДанные.Сумма;
	
КонецПроцедуры

&НаКлиенте
Процедура СоставКомпенсацииСуммаКорректировкиПриИзменении(Элемент)
...
&НаКлиенте
Процедура ЗаполнитьРазницу()
	
	Для Каждого Строка Из Объект.СоставКомпенсации Цикл
		Строка.Разница = Строка.СуммаКорректировки - Строка.Сумма;
	КонецЦикла;
...
Процедура УправлениеДиалогомНаСервере()
	...
	Элементы.СоставКомпенсацииСумма.Видимость = ЗначениеЗаполнено(Объект.ДокументОснование);
...
Процедура УстановитьУсловноеОформление()
	...
	ПолеЭлемента.Поле = Новый ПолеКомпоновкиДанных(Элементы.СоставКомпенсацииНомерСтроки.Имя);
	
	ОтборЭлемента = ЭлементУсловногоОформления.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
	ОтборЭлемента.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("Объект.СоставКомпенсации.Активность");
	...
	ПолеЭлемента = ЭлементУсловногоОформления.Поля.Элементы.Добавить();
	ПолеЭлемента.Поле = Новый ПолеКомпоновкиДанных(Элементы.СоставКомпенсацииИсточник.Имя);
	...
	ПолеЭлемента = ЭлементУсловногоОформления.Поля.Элементы.Добавить();
	ПолеЭлемента.Поле = Новый ПолеКомпоновкиДанных(Элементы.СоставКомпенсацииАвтомобиль.Имя);
	...
	ПолеЭлемента = ЭлементУсловногоОформления.Поля.Элементы.Добавить();
	ПолеЭлемента.Поле = Новый ПолеКомпоновкиДанных(Элементы.СоставКомпенсацииМаркетинговаяПрограмма.Имя);
	...
	ПолеЭлемента = ЭлементУсловногоОформления.Поля.Элементы.Добавить();
	ПолеЭлемента.Поле = Новый ПолеКомпоновкиДанных(Элементы.СоставКомпенсацииСумма.Имя);
	...
	ПолеЭлемента = ЭлементУсловногоОформления.Поля.Элементы.Добавить();
	ПолеЭлемента.Поле = Новый ПолеКомпоновкиДанных(Элементы.СоставКомпенсацииСуммаКорректировки.Имя);
	...
	ПолеЭлемента = ЭлементУсловногоОформления.Поля.Элементы.Добавить();
	ПолеЭлемента.Поле = Новый ПолеКомпоновкиДанных(Элементы.СоставКомпенсацииРазница.Имя);
	...
	ОтборЭлемента = ЭлементУсловногоОформления.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
	ОтборЭлемента.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("Объект.СоставКомпенсации.Разница");
	...
	ЭлементУсловногоОформления.Оформление.УстановитьЗначениеПараметра("ЦветТекста", ЦветаСтиля.ЦветПоложительногоТекстаВиджета);

// Модуль основной формы документа "Изменение цен аренды"
...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	РаботаСФормойКлиент.ЗамерВремениЗапись("ИзменениеЦенАренды", ПараметрыЗаписи.РежимЗаписи, Ложь);
...
Процедура ДатаПриИзмененииНаСервере(ПараметрыДействия = Неопределено)
	...
	Документы.ИзменениеЦенАренды.ДатаПриИзменении(Объект, ПараметрыДействия);
	УправлениеДиалогомНаСервере();
...
&НаСервере
Процедура ВидАрендыПриИзмененииНаСервере()
	
	Документы.ИзменениеЦенАренды.ВидАрендыПриИзменении(Объект);
	УправлениеДиалогомНаСервере();
...
Процедура УправлениеДиалогомНаСервере()
	...
	Элементы.АвтомобилиГод.Видимость     = ДанныеВидаАренды.ТарификацияГод;
	Элементы.АвтомобилиКвартал.Видимость = ДанныеВидаАренды.ТарификацияКвартал;
	Элементы.АвтомобилиМесяц.Видимость   = ДанныеВидаАренды.ТарификацияМесяц;
	Элементы.АвтомобилиНеделя.Видимость  = ДанныеВидаАренды.ТарификацияНеделя;
	Элементы.АвтомобилиСутки.Видимость   = ДанныеВидаАренды.ТарификацияСутки;
	Элементы.АвтомобилиЧас.Видимость     = ДанныеВидаАренды.ТарификацияЧас;
	Элементы.АвтомобилиМинута.Видимость  = ДанныеВидаАренды.ТарификацияМинута;
	Элементы.АвтомобилиДепозит.Видимость = ДанныеВидаАренды.ДепозитИспользование;

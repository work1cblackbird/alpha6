...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// АльфаАвто
	ЗащитаПерсональныхДанныхАльфаАвто.ФормаДокументаОтзывСогласияПриСозданииНаСервере(ЭтотОбъект);
...
Процедура ОтветственныйЗаПДнПриИзмененииНаСервере()
	...
	// АльфаАвто
	// Заменено получение ФИО ответственного
	ЗащитаПерсональныхДанныхПереопределяемый.ЗаполнитьФИОФизическогоЛица(
		Объект.ОтветственныйЗаОбработкуПерсональныхДанных,

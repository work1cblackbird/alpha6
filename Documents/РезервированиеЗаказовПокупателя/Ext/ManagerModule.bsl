...
Процедура ВыполнитьПереносИсполнителяИзСвойств() Экспорт
	...
	Запрос.Текст = 
	"ВЫБРАТЬ
		|	РезервированиеЗаказовПокупателяДополнительныеРеквизиты.Ссылка КАК Ссылка
		|ИЗ
		|	Документ.РезервированиеЗаказовПокупателя.ДополнительныеРеквизиты КАК РезервированиеЗаказовПокупателяДополнительныеРеквизиты
		|ГДЕ
		|	РезервированиеЗаказовПокупателяДополнительныеРеквизиты.Свойство= &РеквизитКУдалению";
	...
	Пока Выборка.Следующий() Цикл
		...
		Попытка
			...
			ЭлементБлокировки = Блокировка.Добавить("Документ.РезервированиеЗаказовПокупателя");
	...
	Если ПеренесеныВсеСвойства Тогда
		...
		"ВЫБРАТЬ
			...
			|ГДЕ
			|	НаборыДополнительныхРеквизитовИСведений.Ссылка.ИмяПредопределенныхДанных = ""Документ_РезервированиеЗаказовПокупателя""";
...
Функция ПроверитьПереносИсполнителяИзСвойств(Параметры) Экспорт
	...
	Запрос.Текст = 
	"ВЫБРАТЬ
		|	РезервированиеЗаказовПокупателяДополнительныеРеквизиты.Свойство КАК Свойство,
		|	РезервированиеЗаказовПокупателяДополнительныеРеквизиты.Значение КАК Значение
		|ИЗ
		|	Документ.РезервированиеЗаказовПокупателя.ДополнительныеРеквизиты КАК РезервированиеЗаказовПокупателяДополнительныеРеквизиты
		|ГДЕ
		|	РезервированиеЗаказовПокупателяДополнительныеРеквизиты.Свойство = &РеквизитКУдалению
		|	И РезервированиеЗаказовПокупателяДополнительныеРеквизиты.Ссылка = &Ссылка";
...
Функция ПечатьРезервированиеЗаказовПокупателя(МассивОбъектов, ОбъектыПечати)
	...
	Для Каждого Документ Из МассивОбъектов Цикл
		...
		Макет = УправлениеПечатью.МакетПечатнойФормы(
			"Документ.РезервированиеЗаказовПокупателя.ПФ_MXL_РезервированиеЗаказовПокупателя");
...
Функция ДобавитьКомандуСоздатьНаОсновании(КомандыСоздатьНаОсновании) Экспорт
	...
	Возврат СозданиеНаОснованииАльфаАвто.ДобавитьКомандуСозданияНаОсновании(КомандыСоздатьНаОсновании,
		Метаданные.Документы.РезервированиеЗаказовПокупателя);

...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	РаботаСФормойКлиент.ЗамерВремениЗапись("ОтчетКомиссионера", ПараметрыЗаписи.РежимЗаписи,
...
Процедура ЗаполнитьСлужебныеРеквизиты()
	...
	Для Каждого СтрокаТовара Из Объект.Товары Цикл
		...
		Если ЕстьРеквизит(СтрокаТовара.ДокументПередачи, "ДоговорВзаиморасчетов") Тогда
			СпособВеденияВзаиморасчетовДоговоров = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(
				СтрокаТовара.ДокументПередачи,
				"ДоговорВзаиморасчетов.СпособВеденияВзаиморасчетов");
			СтрокаТовара.СпособВеденияВзаиморасчетов = СпособВеденияВзаиморасчетовДоговоров;
		КонецЕсли;
...
Процедура УправлениеДиалогомНаСервере()
	...
	УправлениеДиалогомДокументаСервер.УстановитьДоступностьСпособаЗачатаАвансов(ЭтотОбъект,Объект,"Товары");
	
	ТоварыДокумента = Объект.Товары.Выгрузить(, "СпособВеденияВзаиморасчетов");
	Элементы.ТоварыСпособЗачетаАвансов.Видимость = 
		ТоварыДокумента.ВыгрузитьКолонку("СпособВеденияВзаиморасчетов").
			Найти(Перечисления.СпособыВеденияУчетаВзаиморасчетов.ПоСделкам) <> Неопределено;
...
Процедура УстановитьУсловноеОформление()
	...
	ПолеЭлемента.Поле = Новый ПолеКомпоновкиДанных(Элементы.ТоварыСпособЗачетаАвансов.Имя);
	
	ОтборЭлемента = ЭлементУсловногоОформления.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
	ОтборЭлемента.ЛевоеЗначение = 
		Новый ПолеКомпоновкиДанных("Объект.Товары.СпособВеденияВзаиморасчетов");

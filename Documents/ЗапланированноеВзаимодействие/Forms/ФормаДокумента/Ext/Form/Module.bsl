...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// АльфаАвто 
	ВзаимодействияАльфаАвто.ПриСозданииНаСервере(ЭтотОбъект, Элементы.Рассмотрено);
	// Конец АльфаАвто
...
Процедура ПриОткрытии(Отказ)
	...
	// АлфаАвто
	// Запрещено использование данного документа
	ПоказатьПредупреждение(, НСтр("ru = 'Документ ""Запланированное взаимодействие"" не используется.'"));
	Отказ = Истина;
	Возврат;
	// Конец АльфаАвто

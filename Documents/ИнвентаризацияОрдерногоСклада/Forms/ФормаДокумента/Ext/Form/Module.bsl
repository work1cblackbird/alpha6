...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	РаботаСФормойКлиент.ЗамерВремениЗапись("ИнвентаризацияОрдерногоСклада", ПараметрыЗаписи.РежимЗаписи,
...
Процедура ОбновитьОтображениеРазницы()
	...
	Документы.ИнвентаризацияОрдерногоСклада.ОбновитьОтображениеРазницы(Объект);
...
Процедура ШтрихкодированиеОбработкаОповещенияНаСервере(РезультатОповещения, ДополнительныеПараметры)
	...
	РезультатОповещения.Вставить("ИмяРеквизитаКоличество", "КоличествоУчет");

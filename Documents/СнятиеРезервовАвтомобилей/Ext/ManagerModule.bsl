// Модуль менеджера документа "Снятие резервов автомобилей"
...
Процедура ВыполнитьПереносИсполнителяИзСвойств() Экспорт
	...
	Запрос.Текст = 
	"ВЫБРАТЬ
		|	СнятиеРезервовАвтомобилейДополнительныеРеквизиты.Ссылка КАК Ссылка
		|ИЗ
		|	Документ.СнятиеРезервовАвтомобилей.ДополнительныеРеквизиты КАК СнятиеРезервовАвтомобилейДополнительныеРеквизиты
		|ГДЕ
		|	СнятиеРезервовАвтомобилейДополнительныеРеквизиты.Свойство= &РеквизитКУдалению";
	...
	Пока Выборка.Следующий() Цикл
		...
		Попытка
			...
			ЭлементБлокировки = Блокировка.Добавить("Документ.СнятиеРезервовАвтомобилей");
	...
	Если ПеренесеныВсеСвойства Тогда
		...
		"ВЫБРАТЬ
			...
			|ГДЕ
			|	НаборыДополнительныхРеквизитовИСведений.Ссылка.ИмяПредопределенныхДанных = ""Документ_СнятиеРезервовАвтомобилей""";
...
Функция ПроверитьПереносИсполнителяИзСвойств(Параметры) Экспорт
	...
	Запрос.Текст = 
	"ВЫБРАТЬ
		|	СнятиеРезервовАвтомобилейДополнительныеРеквизиты.Свойство КАК Свойство,
		|	СнятиеРезервовАвтомобилейДополнительныеРеквизиты.Значение КАК Значение
		|ИЗ
		|	Документ.СнятиеРезервовАвтомобилей.ДополнительныеРеквизиты КАК СнятиеРезервовАвтомобилейДополнительныеРеквизиты
		|ГДЕ
		|	СнятиеРезервовАвтомобилейДополнительныеРеквизиты.Свойство = &РеквизитКУдалению
		|	И СнятиеРезервовАвтомобилейДополнительныеРеквизиты.Ссылка = &Ссылка";
...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	УправлениеПечатьюПлатформа.ДобавитьКоманду(КомандыПечати,
		...
		"СнятиеРезервовАвтомобилей",
		НСтр("ru = 'Снятие резервов автомобилей'"),
		СсылкаНаДокумент);
...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "СнятиеРезервовАвтомобилей") Тогда
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм,
															"СнятиеРезервовАвтомобилей",
															"Снятие резервов автомобилей",
															ПечатьСнятиеРезервовАвтомобилей(МассивОбъектов, ОбъектыПечати));
	КонецЕсли;
...
Функция ПечатьСнятиеРезервовАвтомобилей(МассивОбъектов, ОбъектыПечати) Экспорт
	...
	Для Каждого Документ Из МассивОбъектов Цикл
		...
		Макет = УправлениеПечатью.МакетПечатнойФормы("Документ.СнятиеРезервовАвтомобилей.ПФ_MXL_СнятиеРезервовАвтомобилей");
	...
	ИмяПараметровПечати = "ПАРАМЕТРЫ_ПЕЧАТИ_СнятиеРезервовАвтомобилей_СнятиеРезервовАвтомобилей";
	УправлениеПечатьюПлатформа.УстановитьСтандартныеПараметрыПечати(ИмяПараметровПечати, ТабличныйДокумент);
	ТабличныйДокумент.ИмяПараметровПечати = ИмяПараметровПечати;
	
	Возврат ТабличныйДокумент;
	
КонецФункции // ПечатьСнятиеРезервовАвтомобилей()
...
Функция ДобавитьКомандуСоздатьНаОсновании(КомандыСоздатьНаОсновании) Экспорт
	...
	Возврат СозданиеНаОснованииАльфаАвто.ДобавитьКомандуСозданияНаОсновании(КомандыСоздатьНаОсновании,
		Метаданные.Документы.СнятиеРезервовАвтомобилей);

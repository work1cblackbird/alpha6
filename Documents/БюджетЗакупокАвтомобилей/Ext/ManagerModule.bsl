// Модуль менеджера документа "Бюджет закупок автомобилей"
...
//  ПараметрыДействия - Структура            - Набор параметров, использующихся при выполнения операции.
//
Процедура СценарийПланированияПриИзменении(Объект, ПараметрыДействия) Экспорт
...
// Обработчик изменения модели в ТЧ "Автомобили"
//
// Параметры:
...
Процедура ДобавитьКомандыЗаполнения(КомандыЗаполнения, Параметры) Экспорт
	...
	ОтображатьЗаполнитьИзФайла = ПраваИНастройкиПользователя.Значение("ОтображатьЗаполнитьИзФайла", "БюджетЗакупокАвтомобилей");
	...
	ФормаАвтозаполнения.ВыборСсылки 		= "Документ.БюджетЗакупокАвтомобилей.Форма.ФормаДляЗаполненияПростымСпособом";
	...
	ФормаАвтозаполнения 					= ПоследовательныеОперацииКлиентСервер.НовыйВыборСсылки();
	ФормаАвтозаполнения.ВыборСсылки 		= "Документ.БюджетЗакупокАвтомобилей.Форма.ФормаДляЗаполненияМатМетодами";
	ФормаАвтозаполнения.Обязательный 		= Истина;
	...
	ФормаАвтозаполнения 					= ПоследовательныеОперацииКлиентСервер.НовыйВыборСсылки();
	ФормаАвтозаполнения.ВыборСсылки 		= "Документ.БюджетЗакупокАвтомобилей.Форма.ФормаДляЗаполненияПоДокументуОснованию";
	ФормаАвтозаполнения.Обязательный 		= Истина;
...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	УправлениеПечатьюПлатформа.ДобавитьКоманду(КомандыПечати,
		"Документ.БюджетЗакупокАвтомобилей",
		"ПФ_MXL_БюджетЗакупокАвтомобилей",
		НСтр("ru = 'Бюджет закупок автомобилей'"),
		СсылкаНаДокумент);
...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ПФ_MXL_БюджетЗакупокАвтомобилей") Тогда
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм,
															"ПФ_MXL_БюджетЗакупокАвтомобилей",
															"Бюджет закупок автомобилей",
															ПечатьБюджетЗакупокАвтомобилей(МассивОбъектов, ОбъектыПечати));
...
//
Функция ПечатьБюджетЗакупокАвтомобилей(МассивОбъектов, ОбъектыПечати) Экспорт
	ТабличныйДокумент = Новый ТабличныйДокумент;
	
	// Добавим установку параметров печати
	ИмяПараметровПечати = "ПАРАМЕТРЫ_ПЕЧАТИ_БюджетЗакупокАвтомобилей_БюджетЗакупокАвтомобилей";
	...
	Для Каждого Документ Из МассивОбъектов Цикл
		...
		Макет = УправлениеПечатью.МакетПечатнойФормы("Документ.БюджетЗакупокАвтомобилей.ПФ_MXL_БюджетЗакупокАвтомобилей");
...
Функция ДобавитьКомандуСоздатьНаОсновании(КомандыСоздатьНаОсновании) Экспорт
	...
	Возврат СозданиеНаОснованииАльфаАвто.ДобавитьКомандуСозданияНаОсновании(КомандыСоздатьНаОсновании,
		Метаданные.Документы.БюджетЗакупокАвтомобилей);

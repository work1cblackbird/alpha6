///////////////////////////////////////////////////////////////////////////////
// Модуль основной формы документа "Ввывод из эксплуатации автомобилей"
//
///////////////////////////////////////////////////////////////////////////////
...
Процедура ПриЧтенииНаСервере(ТекущийОбъект)
	...
	// Заполним лужебные рекизиты табличой части "Активы"
	ОбработкаТабличнойЧастиАктивы.ЗаполнитьСлужебныеРеквизиты(Объект);
...
Процедура ПослеЗаписиНаСервере(ТекущийОбъект, ПараметрыЗаписи)
	...
	// Заполним служебные рекизиты табличой части "Активы"
	ОбработкаТабличнойЧастиАктивы.ЗаполнитьСлужебныеРеквизиты(Объект);
...
Процедура ДатаПриИзмененииНаСервере(ПараметрыДействия = Неопределено)
	...
	Документы.ВыводИзЭксплуатацииАвтомобилей.ДатаПриИзменении(Объект, ПараметрыДействия);
	УправлениеДиалогомНаСервере();
...
Процедура ХозОперацияПриИзмененииНаСервере(ПараметрыДействия = Неопределено)
	...
	Документы.ВыводИзЭксплуатацииАвтомобилей.ХозОперацияПриИзменении(Объект, ПараметрыДействия);
	НастроитьПараметрыВыбораЭлементовФормы();
	УправлениеДиалогомНаСервере();
...
Процедура СкладКомпанииПриИзмененииНаСервере(ПараметрыДействия = Неопределено)
	...
	Документы.ВыводИзЭксплуатацииАвтомобилей.СкладКомпанииПриИзменении(Объект, ПараметрыДействия);
	УправлениеДиалогомНаСервере();
...
Процедура АктивыПрочийАктивПриИзмененииНаСервере(ПараметрыДействия = Неопределено)
	...
	Документы.ВыводИзЭксплуатацииАвтомобилей.АктивыПрочийАктивПриИзменении(Объект, ТекущиеДанные, ПараметрыДействия);
	
КонецПроцедуры

&НаКлиенте
Процедура АктивыАвтомобильПриИзменении(Элемент)
	
	АктивыАвтомобильПриИзмененииНаСервере();
	
КонецПроцедуры

&НаСервере
Процедура АктивыАвтомобильПриИзмененииНаСервере(ПараметрыДействия = Неопределено)
	
	ТекущиеДанные = Объект.Активы.НайтиПоИдентификатору(Элементы.Активы.ТекущаяСтрока);
	Документы.ВыводИзЭксплуатацииАвтомобилей.АктивыАвтомобильПриИзменении(Объект, ТекущиеДанные, ПараметрыДействия);

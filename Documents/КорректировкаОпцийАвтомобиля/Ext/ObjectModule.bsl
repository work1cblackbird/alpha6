// Модуль объекта документа "Корректировка опций автомобиля"
...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения = "", СтандартнаяОбработка = Истина) Экспорт
	...
	// Заполним ТЧ опциями автомобиля
	Документы.КорректировкаОпцийАвтомобиля.ЗаполнитьОпцииАвтомобиля(ЭтотОбъект);
...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	// Добавить запись в регистр опций
...
Функция ОбработкаЗаполнения_ЗаказПоставщикуНаАвтомобиль(ДанныеЗаполнения,
	...
	// Обработаем по аналогии с докумнтом "Заказ на автомобиль"
...
// Производит заполнение объекта на основании документа "Корректировка опций автомобиля".
//
// Параметры:
//  ДанныеЗаполнения     - Произвольный - Значение, которое используется как основание для заполнения.
//  ТекстЗаполнения      - Строка       - Текст, используемый для заполнения объекта.
...
//  Булево - Признак возможности дальнейшей обработки события.
//
Функция ОбработкаЗаполнения_КорректировкаОпцийАвтомобиля(ДанныеЗаполнения,
	ТекстЗаполнения = "",
	СтандартнаяОбработка = Истина) Экспорт
...
КонецФункции // ОбработкаЗаполнения_КорректировкаОпцийАвтомобиля()
...
КонецФункции // ОбработкаЗаполнения_Автомобили()

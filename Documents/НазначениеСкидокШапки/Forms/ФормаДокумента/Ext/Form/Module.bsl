...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	РаботаСФормойКлиент.ЗамерВремениЗапись("НазначениеСкидокШапки", ПараметрыЗаписи.РежимЗаписи,
		Объект.Скидки.Количество() > 50);
...
Процедура УстановитьУсловноеОформление()
	...
	ЭлементУсловногоОформления.Поля.Элементы.Добавить().Поле = Новый ПолеКомпоновкиДанных(Элементы.СкидкиЗначениеСкидки.Имя);

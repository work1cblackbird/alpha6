// Модуль объекта документа "Бюджет оказания услуг по автоработам"
...
// Производит заполнение объекта на основании документа "Бюджет оказания услуг по автоработам".
//
// Параметры:
...
//
Функция ОбработкаЗаполнения_БюджетОказанияУслугПоАвтоработам(ДанныеЗаполнения,
	ТекстЗаполнения = "",
...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения="", СтандартнаяОбработка=ИСТИНА) Экспорт
	...
	Если ЭтотОбъект.ЭтоНовый() Тогда
		ЭтотОбъект.ТипЦен = ПраваИНастройкиПользователя.Значение(ПланыВидовХарактеристик.ПраваИНастройки.ОсновнойТипЦенРабот, ЭтотОбъект);

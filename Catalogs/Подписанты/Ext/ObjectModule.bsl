...
Процедура ПередЗаписью(Отказ)
	...
	Если ВидПодписанта = Перечисления.ВидыПодписантов.ПодписантОтКонтрагента Тогда
		
		Организация = Справочники.Организации.ПустаяСсылка();
		Подразделение = Справочники.ПодразделенияКомпании.ПустаяСсылка();
		
	ИначеЕсли ВидПодписанта = Перечисления.ВидыПодписантов.ПодписантОтОрганизации Тогда

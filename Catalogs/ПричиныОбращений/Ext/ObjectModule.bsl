// Модуль объекта справочника "Причины обращений"
...
Процедура ПередЗаписью(Отказ)
	...
	Если Не ЭтоГруппа И ЭтоНовый() И Не ЗначениеЗаполнено(ТипАвторабот) Тогда
		
		ТипАвторабот = Справочники.ТипыАвторабот.ПоУмолчанию;

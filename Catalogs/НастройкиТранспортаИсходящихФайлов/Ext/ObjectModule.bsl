...
Процедура ОчиститьЛишниеНастройки()
	
	ПоляКОчистке = Новый Массив();
	
	Если Вид = ПредопределенноеЗначение("Перечисление.ВидыТранспортаФайлов.EMail") Тогда
		
		ПоляКОчистке.Добавить("Том");
		ПоляКОчистке.Добавить("Каталог");
		ПоляКОчистке.Добавить("URLСервера");
		ПоляКОчистке.Добавить("Порт");
		ПоляКОчистке.Добавить("Таймаут");
		ПоляКОчистке.Добавить("Логин");
		ПоляКОчистке.Добавить("Пароль");
		ПоляКОчистке.Добавить("SSL");
		
	ИначеЕсли Вид = ПредопределенноеЗначение("Перечисление.ВидыТранспортаФайлов.FTP") Тогда
		
		ПоляКОчистке.Добавить("Том");
		ПоляКОчистке.Добавить("Каталог");
		ПоляКОчистке.Добавить("Адреса");
		ПоляКОчистке.Добавить("Копии");
		ПоляКОчистке.Добавить("СкрытыеКопии");
		ПоляКОчистке.Добавить("Отправитель");
		
	ИначеЕсли Вид = ПредопределенноеЗначение("Перечисление.ВидыТранспортаФайлов.Каталог") Тогда
	...
	Для Каждого Поле Из ПоляКОчистке Цикл

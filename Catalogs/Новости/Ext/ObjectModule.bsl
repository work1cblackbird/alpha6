...
Процедура ПередЗаписью(Отказ)
	...
	Если (ДополнительныеСвойства.Свойство("ЭтоЗагрузкаНовостей")) // АПК:1416 свойства может не существовать.
...
Процедура ПриЗаписи(Отказ)
	...
	Если ДополнительныеСвойства.ЭтоНовый <> Истина Тогда
		Если ( // Изменилась важность новости - новость стала Важная или Очень важная.
				...
				ИЛИ (// Если новость загружается заново (перепубликация, отзыв новости и т.п.), то сбросить все пользовательские свойства прочтенности новости - прочтенность, оповещение и т.п.
					(ДополнительныеСвойства.Свойство("СброситьПользовательскиеСвойстваПрочтенностиНовости") = Истина) // АПК:1416 свойства может не существовать.
	...
	Если (ДополнительныеСвойства.Свойство("ТребуетсяПересчетОтборов")) // АПК:1416 свойства может не существовать.

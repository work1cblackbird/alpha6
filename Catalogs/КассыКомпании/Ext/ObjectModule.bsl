...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка) Экспорт
	...
	Если НЕ ЗначениеЗаполнено(ПодразделениеКомпании) Тогда
		ПодразделениеКомпании = Пользователи.ТекущийПользователь().ПодразделениеКомпании;
		Справочники.КассыКомпании.ПодразделениеКомпанииПриИзменении(ЭтотОбъект);
	КонецЕсли;
	
	Если НЕ ЗначениеЗаполнено(Организация) Тогда
		Организация = Пользователи.ТекущийПользователь().Организация;
		Справочники.КассыКомпании.ОрганизацияПриИзменении(ЭтотОбъект);
	КонецЕсли;

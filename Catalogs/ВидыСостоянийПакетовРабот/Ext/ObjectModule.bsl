// Модуль объекта справочника "Виды состояний пакетов работ"
...
Процедура ПередУдалением(Отказ)
	...
	Пока Выборка.Следующий() Цикл
		МенеджерЗаписи = РегистрыСведений.СостоянияПакетовРабот.СоздатьМенеджерЗаписи();

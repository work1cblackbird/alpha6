...
// Формирует полное наименования для варианта по полям
//
// Параметры:
//  Объект - СправочникОбъект.ВариантКомплектации - объект варианта комплектации
//  ПараметрыДействия - Структура - дополнительные параметры формирования
//
...
Функция ПолучитьОбязательныеРеквизиты(Объект) Экспорт
	...
	Если НЕ Объект.Ссылка.ЭтоГруппа Тогда
...
//              (1-Обязательный, 2-Уникальный, 3-Уникальный и обязательный). Для описания проверки табличных частей
//              используется вложенная структура.
//
...
Процедура НаименованиеПриИзменении(Объект, ПараметрыДействия=Неопределено) Экспорт
	...
	СформироватьПолноеНаименование(Объект, ПараметрыДействия);

// Модуль объекта справочника "Виды состояний заказ нарядов"
...
Процедура ПередУдалением(Отказ)
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |	ЖурналСостояний.Объект КАК Объект
	               |ИЗ
	               |	РегистрСведений.ЖурналСостояний КАК ЖурналСостояний
	               |ГДЕ
	               |	ЖурналСостояний.Состояние = &Ссылка";
	...
	Пока Выборка.Следующий() Цикл
		МенеджерЗаписи = РегистрыСведений.ЖурналСостояний.СоздатьМенеджерЗаписи();

...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	КэшНаименование = Справочники.ВозрастныеГруппы.СформироватьНаименованиеПоУмолчанию(Объект);
...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	РаботаСФормойКлиент.ЗамерВремениЗапись("ВозрастныеГруппы");
...
// "Начало интервала" и "Конец интервала" в контексте сервера.
&НаСервере

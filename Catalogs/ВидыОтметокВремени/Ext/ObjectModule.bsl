// Модуль объекта справочника "Виды отметок времени"
...
Процедура ПередУдалением(Отказ)
	...
	Запрос.Текст = "ВЫБРАТЬ
	               |	ФактическоеВремя.Период КАК Период,
	               |	ФактическоеВремя.ЗаказНаряд КАК ЗаказНаряд,
	               ...
	               |ГДЕ
	               |	ФактическоеВремя.Состояние = &Ссылка";
	...
	Пока Выборка.Следующий() Цикл
		МенеджерЗаписи = РегистрыСведений.ФактическоеВремя.СоздатьМенеджерЗаписи();
...
////////////////////////////////////////////////////////////////////////////////
// ИСПОЛНЯЕМАЯ ЧАСТЬ МОДУЛЯ#КонецЕсли

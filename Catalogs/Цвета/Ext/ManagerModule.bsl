// Модуль менеджера справочника "Цвета"
...
Функция ПолучитьОбязательныеРеквизиты(Объект) Экспорт
	...
	ОбязательныеРеквизиты.Добавить("ЦветПоГИБДД");
...
Процедура НаименованиеПриИзменении(Объект, ПараметрыДействия=Неопределено) Экспорт
	...
	Если НЕ ЗначениеЗаполнено(Объект.ЦветПоГИБДД) Тогда
		Объект.ЦветПоГИБДД = Объект.Наименование;
	КонецЕсли;

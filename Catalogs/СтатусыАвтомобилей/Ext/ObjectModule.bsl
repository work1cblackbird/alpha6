// Модуль объекта справочника "Статусы автомобилей"
...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	// Проверим, относится ли данный статус к заказам покупателей или к заказам поставщику.
	Если НЕ ЗаказПокупателя И НЕ ЗаказПоставщику Тогда
		
		Отказ = Истина;
		ОбщегоНазначения.СообщитьПользователю(НСтр("ru = 'Данный статус не относится ни к заказам покупателя, ни к заказам поставщику.'"));

// Модуль объекта справочника "ВидыВременногоИспользования"
...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка) Экспорт
	...
	// Вызываем общий обработчик события
	Если НЕ ОбработкаСобытийСправочникаСервер.ОбработкаЗаполнения(
			ЭтотОбъект,
			ДанныеЗаполнения,
			ТекстЗаполнения, 
	...
	Если Не ЭтоГруппа Тогда 
		ТипАренды = Перечисления.ТипыРемонта.Платный;
	КонецЕсли;
...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если ТипАренды = Перечисления.ТипыРемонта.Платный
		И НЕ (ТарификацияГод ИЛИ ТарификацияКвартал ИЛИ ТарификацияМесяц
			ИЛИ ТарификацияНеделя ИЛИ ТарификацияСутки ИЛИ ТарификацияЧас ИЛИ ТарификацияМинута) Тогда
		ОбщегоНазначения.СообщитьПользователю(
			НСтр("ru = 'Для платного вида аренды необходимо установить один из признаков тарификации по периодам.'"),
			,
			,
			,
			Отказ);

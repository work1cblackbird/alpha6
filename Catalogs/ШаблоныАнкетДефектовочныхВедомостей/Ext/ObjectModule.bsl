// Модуль объекта справочника "Шаблоны анкет дефектовочных ведомостей"
...
Процедура ПередЗаписью(Отказ)
	...
	Если НЕ ЗначениеЗаполнено(ЭтотОбъект.Применимость) Тогда
		ЭтотОбъект.Применимость = Неопределено;
	КонецЕсли;

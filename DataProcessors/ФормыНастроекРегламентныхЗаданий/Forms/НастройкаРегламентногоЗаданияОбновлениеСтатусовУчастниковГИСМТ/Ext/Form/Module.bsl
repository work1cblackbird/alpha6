...
Процедура ПрочитатьПараметры()
	...
	РегламентноеЗадание = РегламентныеЗадания.НайтиПредопределенное(Метаданные.РегламентныеЗадания.ОбновлениеСтатусовУчастниковГИСМТ);
	...
	Если СтруктураПараметров.Свойство("СрокОбновления") Тогда
		СрокОбновления = СтруктураПараметров.СрокОбновления;
	КонецЕсли;
...
Процедура ЗаписатьПараметры()
	...
	СтруктураПараметров.Вставить("СрокОбновления", СрокОбновления);

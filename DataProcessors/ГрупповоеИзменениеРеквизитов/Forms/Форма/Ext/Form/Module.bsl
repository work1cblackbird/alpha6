...
Процедура ЗаполнитьРеквизитыОбъекта(СведенияОРеквизитах, ДоступныеРеквизиты)
	...
	ДобавитьРеквизитыВНабор(СведенияОРеквизитах, ОбъектМетаданных, ДоступныеРеквизиты, МассивОбщихРеквизитов);
	// Конец АльфаАвто
	...
	Если ПодсистемаСуществует("СтандартныеПодсистемы.Свойства") Тогда
		...
		Если МодульУправлениеСвойствами <> Неопределено Тогда
			...
			Если ИспользуютсяДопРеквизиты Или ИспользуютсяДопСведения Тогда
				ДобавитьДополнительныеРеквизитыИСведенияВНабор(СведенияОРеквизитах); // АльфаАвто
			КонецЕсли;
		КонецЕсли;
	КонецЕсли;
...
&НаСервере
Процедура ДобавитьДополнительныеРеквизитыИСведенияВНабор(СведенияОРеквизитах) // АльфаАвто
	
	// АльфаАвто
	НеРедактируемые      = СведенияОРеквизитах.НередактируемыеРеквизиты;
	ФильтруемыеРеквизиты = СведенияОРеквизитах.ФильтруемыеРеквизиты;
	// Конец АльфаАвто

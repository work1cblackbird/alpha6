...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// АльфаАвто
	ДобавитьКнопкуНастроекРегламентногоЗадания();
	// Конец АльфаАвто
...
Процедура ДобавитьКнопкуНастроекРегламентногоЗадания()
	
	МассивРеквизитов = Новый Массив;
 	НоваяКолонка = Новый РеквизитФормы("Имя", 					Новый ОписаниеТипов("Строка"), "ТаблицаРегламентныеЗадания");
	МассивРеквизитов.Добавить(НоваяКолонка);
	НоваяКолонка = Новый РеквизитФормы("ЕстьФормаНастройки", 	Новый ОписаниеТипов("Булево"), "ТаблицаРегламентныеЗадания");
    МассивРеквизитов.Добавить(НоваяКолонка);
    ИзменитьРеквизиты(МассивРеквизитов); 	
	
	НоваяКоманда 			= Команды.Добавить("НастройкаРегламентногоЗадания");     
	НоваяКоманда.Действие 	= "НастройкаРегламентногоЗадания";
	НоваяКоманда.Заголовок 	= "Параметры";
	
	НовыйЭлемент 			= Элементы.Вставить("ТаблицаРегламентныеЗаданияНастройкаРегламентногоЗадания", Тип("КнопкаФормы"), 
		Элементы.ТаблицаРегламентныеЗадания.КоманднаяПанель, Элементы.ТаблицаРегламентныеЗаданияСкопировать);
	НовыйЭлемент.ИмяКоманды = "НастройкаРегламентногоЗадания";
	НовыйЭлемент.Вид		= ВидКнопкиФормы.КнопкаКоманднойПанели;
	
	Элементы.ТаблицаРегламентныеЗадания.УстановитьДействие("ПриАктивизацииСтроки", "ТаблицаРегламентныеЗаданияПриАктивизацииСтроки");
...
Процедура ТаблицаРегламентныеЗаданияПриАктивизацииСтроки(Элемент)
	...
	Если НЕ Элементы.ТаблицаРегламентныеЗадания.ТекущиеДанные = Неопределено Тогда
		Элементы.ТаблицаРегламентныеЗадания.КоманднаяПанель.ПодчиненныеЭлементы.ТаблицаРегламентныеЗаданияНастройкаРегламентногоЗадания.Доступность = 
			Элементы.ТаблицаРегламентныеЗадания.ТекущиеДанные.ЕстьФормаНастройки;
	КонецЕсли;
...
Процедура НастройкаРегламентногоЗадания(Команда)
	...
	Идентификатор = Элементы.ТаблицаРегламентныеЗадания.ТекущиеДанные.Идентификатор;
	ПараметрыФормы.Вставить("Идентификатор", Идентификатор);
	
	ОткрытьФорму("Обработка.ФормыНастроекРегламентныхЗаданий.Форма.НастройкаРегламентногоЗадания" + ТекРегламентноеЗадание, 

...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		// АльфаАвто
		// Изменено формирование типизации номенклатуры
		Элементы.СопоставлениеНоменклатура.ОграничениеТипа = 
			СопоставлениеНоменклатурыКонтрагентовАльфаАвто.ОграничениеТипаНоменклатуры();
		// Конец АльфаАвто
	КонецЕсли;
	...
	// АльфаАвто
	СопоставлениеНоменклатурыКонтрагентовАльфаАвто.ФормаСопоставленияНоменклатурыБЭДПриСозданииНаСервере(ЭтотОбъект);
	// Конец АльфаАвто
...
Процедура СопоставлениеНоменклатураПриИзменении(Элемент)
	...
	// АльфаАвто
	СопоставлениеНоменклатураПриИзмененииНаСервере();
	// Конец АльфаАвто
...
// АльфаАвто
&НаСервере
Процедура СопоставлениеНоменклатураПриИзмененииНаСервере()
	
	ТекущаяСтрока = Объект.Сопоставление.НайтиПоИдентификатору(Элементы.Сопоставление.ТекущаяСтрока);
	
	СопоставлениеНоменклатурыКонтрагентовАльфаАвто.ЗаполнитьРеквизитыНоменклатурыБазы(ТекущаяСтрока);
...
Процедура УстановитьПараметрыВыбораНоменклатуры()
	...
	// АльфаАвто
	ВсеПараметрыВыбора.Добавить(Новый ПараметрВыбора("Отбор.ПометкаУдаления", Ложь));
	// Конец АльфаАвто
...
Процедура ЗакончитьПоискВариантовНаСервере(Результат, ДополнительныеПараметры)
	...
	// АльфаАвто
	НоменклатураБазыСопоставления = СтруктураРезультата.ТаблицаСопоставления.ВыгрузитьКолонку("Номенклатура");
	СопоставлениеНоменклатурыКонтрагентовАльфаАвто.ЗаполнитьДанныеНоменклатурыБазы(
		НоменклатураБазыСопоставления,
...
Процедура ИзменитьЗаписиСопоставленияНоменклатуры(Элемент, ПараметрыОтбора,ТребуетсяПоискВариантов, НаборНоменклатурыКонтрагента, Свойства = Неопределено)
	...
	Для Каждого Запись Из ЗаписиСопоставления Цикл
		...
		// АльфаАвто
		СопоставлениеНоменклатурыКонтрагентовАльфаАвто.ЗаполнитьРеквизитыНоменклатурыБазы(Запись);
		// Конец АльфаАвто

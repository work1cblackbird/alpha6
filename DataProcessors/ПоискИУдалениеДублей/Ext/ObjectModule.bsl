...
Функция ОбъектВТаблицуЗначений(Знач ОбъектДанных, Знач РасшифровкаДополнительныхПолей)
	...
	Для Каждого МетаРеквизит Из Метаданные.ОбщиеРеквизиты Цикл
		ЗначениеСостава = МетаРеквизит.Состав.Найти(МетаданныеОбъекты);
...
Функция ДоступныеРеквизитыОтбора(ОбъектМетаданных)
	...
	Для Каждого МетаРеквизит Из Метаданные.ОбщиеРеквизиты Цикл
		...
		Если ЗначениеСостава=Неопределено ИЛИ (НЕ ЗначениеСостава.Использование=Метаданные.СвойстваОбъектов.ИспользованиеОбщегоРеквизита.Использовать)
			ИЛИ МетаРеквизит.Тип.СодержитТип(Тип("ХранилищеЗначения")) Тогда
			Продолжить;
		КонецЕсли;
		МассивРеквизитов.Добавить(МетаРеквизит.Имя);
	КонецЦикла;
	// Конец АльфаАвто

...
Функция ИмяФормыВводаКонтактнойИнформации(Знач ВидИнформации)
	...
	ИначеЕсли ТипИнформации = ПредопределенноеЗначение(ВсеТипы + "Телефон") Тогда
		// АльфаАвто
		// Заменим на свою форму, поскольку в БСП не предусмотрена возможность хранения истории телефона
		Возврат "Обработка.ВводКонтактнойИнформации.Форма.ВводТелефонаАльфаАвто";
		// Конец АльфаАвто

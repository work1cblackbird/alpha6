...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// АльфаАвто
	Команда = Команды.Добавить("РаботаСККТ");
	Команда.Заголовок = НСтр("ru = 'Работа с ККТ'");
	Команда.Действие = "Подключаемый_РаботаСККТ";
	
	Элемент = Элементы.Добавить("РаботаСККТ", Тип("КнопкаФормы"), Элементы.ГруппаДополнительно);
	Элемент.Вид = ВидКнопкиФормы.Гиперссылка;
	Элемент.ИмяКоманды = "РаботаСККТ";
	// Конец АльфаАвто
...
// АльфаАвто
&НаКлиенте
Процедура Подключаемый_РаботаСККТ(Команда) Экспорт
...
Процедура УстановитьВидимостьРазделов()
	...
	// АльфаАвто не используется стандартная обраотка печати этикеток и ценников

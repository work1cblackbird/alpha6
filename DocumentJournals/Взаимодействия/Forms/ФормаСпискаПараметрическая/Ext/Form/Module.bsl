...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// АльфаАвто
	ВзаимодействияАльфаАвто.ЖурналВзаимодействияПриСозданииНаСервере(ЭтотОбъект);
	// Конец АльфаАвто
...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	...
	// АльфаАвто
	Если ВРег(ИсточникВыбора.ИмяФормы) = ВРег("Справочник.Сотрудники.Форма.ФормаСписка") Тогда
	// Конец АльфаАвто

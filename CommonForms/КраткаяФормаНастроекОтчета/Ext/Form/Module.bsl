...
#Область ОбработчикиСобытийЭлементовТаблицыФормыГруппировкаСтроки
...
#Область ОбработчикиСобытийЭлементовТаблицыФормыГруппировкаКолонок
...
КонецПроцедуры // ПараметрыПриИзменении()
...
#Область ОбработчикиКомандТаблицыФормыГруппировкиСтрок
...
#Область ОбработчикиКомандТаблицыФормыГруппировкиКолонок
...
#Область ОбработчикиКомандТаблицыФормыПоказатели
...
#Область ОбработчикиКомандТаблицыФормыОтборы
...
Процедура ОбновитьНастройкиСКД(ОтсекатьГруппировки = Ложь)
	...
	Для Каждого ЭлементОтбора Из НастройкиСКД.Отбор.ДоступныеПоляОтбора.Элементы Цикл
		...
		Иначе
			...
			ПродолжитьЗаполнениеПолейСвязиПараметровВыбора(ЭлементОтбора, Счетчик, НовыеРеквизиты, НастройкиСКД);
...
Процедура ОбновитьНастройкиОтчета(НастройкиОтчета)
	...
	Для Каждого ЭлементОтбора Из НастройкиОтчета.Отбор.ДоступныеПоляОтбора.Элементы Цикл
		...
		Иначе
			...
			ПродолжитьЗаполнениеПолейСвязиПараметровВыбора(ЭлементОтбора, Счетчик, НовыеРеквизиты, НастройкиОтчета);

...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// АльфаАвто
	РежимПросмотра = Ложь;
	Если ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(Параметры, "РежимПросмотра", Ложь) Тогда
		Элементы.МеткиКонтекстноеМенюСоздать.Видимость = Ложь;
		Элементы.МеткиКонтекстноеМенюИзменить.Видимость = Ложь;
		Элементы.МеткиЗначение.Доступность = Ложь;
		Элементы.МеткиКонтекстноеМенюУстановитьВсе.Видимость = Ложь;
...
Процедура Создать(Команда)
	...
	// АльфаАвто
	УправлениеСвойствамиАльфаАвтоКлиент.ОткрытьФормуСозданияМетки(ЭтотОбъект);
	// Конец АльфаАВто

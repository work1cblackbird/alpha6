...
Процедура ПриЗагрузкеВариантаНаСервере(Настройки)
	...
	КонецЕсли;
	//ТипыЦенПараметр=Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.Элементы.Найти("ТипыЦен");

	//
	//СписокТиповЦен = Новый СписокЗначений;
	//Для каждого ТипЦен из ТипыЦенПараметр.Значение Цикл 
	//		СписокТиповЦен.Добавить(ТипЦен);
	//КонецЦикла;
	ОбновитьНастройкиОтчета(Отчет.КомпоновщикНастроек.ПолучитьНастройки());
	//Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("ТипыЦен",СписокТиповЦен);

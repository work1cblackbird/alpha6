...
Функция НастройкаИнтерваловНаСервере()
	...
	ЗначениеПараметраНепросроченныйДолг = Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.Элементы.Найти("ВыводитьНепросроченныйДолг").Значение;
	...
	Таблицы.Вставить("ВыводитьНепросроченныйДолг", ЗначениеПараметраНепросроченныйДолг);
...
Процедура Подключаемый_ОповещениеЗакрытияОкнаНастройкиИнтерваловНаСервере(РезультатЗакрытия, ДополнительныеПараметры)
	...
	Если НЕ РезультатЗакрытия = Неопределено Тогда
		...
		ЗначениеНепросроченныйДолг = Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.Элементы.Найти("ВыводитьНепросроченныйДолг");
		...
		ЗначениеНепросроченныйДолг.Значение = Таблицы.ВыводитьНепросроченныйДолг;
	КонецЕсли;

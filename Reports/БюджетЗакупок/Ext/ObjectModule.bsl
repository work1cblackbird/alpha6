...
//
// Параметры:
//  Изменение						- Число	- Количество месяцев, необходимое добавить к дате.
//  ДатаНачалаПериодаФормыОтчета	- Дата	- Дата начала периода.
//  ДатаКонцаФормыПериодаОтчета		- Дата	- Дата конца периода.
//
...
//
// Параметры:
//  ТаблицаЗаголовка - ТаблицаЗначений -Таблица, которую необходимо скорректировать.
//

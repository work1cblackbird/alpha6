...
Процедура ПриЗагрузкеВариантаНаСервере(Настройки)
	...
	Отчет
		...
		.Настройки
		.ПараметрыДанных
		.УстановитьЗначениеПараметра("Валюта", Константы.ВалютаРегламентированногоУчетаОрганизаций.Получить());
	...
	СписокТиповЦен = Новый СписокЗначений();
	 ...
	 Для каждого ТипЦен Из Отчет.ТипыЦен Цикл
	 	...
	 	Если ТипЦен.Использование И ТипЗнч(ТипЦен.ТипЦены) <> Тип("Строка") Тогда
	 		...
	 		СписокТиповЦен.Добавить(ТипЦен.ТипЦены,, ТипЦен.Использование);
			
		КонецЕсли;
		
	КонецЦикла;
	
	Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("ВыводимыеТипыЦен", СписокТиповЦен);	

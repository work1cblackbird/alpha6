...
Процедура ЗаполнитьПараметры()
	...
	Если НЕ ЗначениеЗаполнено(ТипЗакупочныхЦен.Значение) Тогда
		ТипЗакупочныхЦен.Значение 	   = ПраваИНастройкиПользователя.Значение("ОсновнойТипЦенЗакупкиАвтомобилей");;
	...
	Если НЕ ЗначениеЗаполнено(ТипЦенПродажи.Значение) Тогда
		ТипЦенПродажи.Значение 	    = ПраваИНастройкиПользователя.Значение("ОсновнойТипЦенПродажиАвтомобилей");;

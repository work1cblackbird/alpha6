...
Процедура СформироватьОтчет(Команда)
	...
	УстановленныеПараметры = Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных;
	
	СписокТиповЦен = ПолучитьТипЦенПоУмолчанию();
	// по умолчанию установим типы цен, установленные в правах пользователя
	ТипЗакупочныхЦен = УстановленныеПараметры.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("ТипЦеныЗакупки"));
	Если НЕ ЗначениеЗаполнено(ТипЗакупочныхЦен.Значение) Тогда
		ТипЗакупочныхЦен.Значение 	   = СписокТиповЦен.ТипЦеныЗакупки;
		ТипЗакупочныхЦен.Использование = Истина;
	КонецЕсли;
	
	ТипЦенПродажи = УстановленныеПараметры.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("ТипЦеныПродажи"));
	Если НЕ ЗначениеЗаполнено(ТипЦенПродажи.Значение) Тогда
		ТипЦенПродажи.Значение 	    = СписокТиповЦен.ТипЦеныПродажи;
		ТипЦенПродажи.Использование = Истина;
	КонецЕсли;
...
Функция ПолучитьТипЦенПоУмолчанию() 
	...
	СписокТиповЦен = Новый Структура;
	СписокТиповЦен.Вставить("ТипЦеныЗакупки", ПраваИНастройкиПользователя.Значение("ОсновнойТипЦенЗакупкиАвтомобилей"));
	СписокТиповЦен.Вставить("ТипЦеныПродажи", ПраваИНастройкиПользователя.Значение("ОсновнойТипЦенПродажиАвтомобилей"));
